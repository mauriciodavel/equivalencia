...
public class TelaLogin extends javax.swing.JFrame {
    ...
    public TelaLogin() {
        ...
        if (conexao != null) {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/equivalencia/icones/dbOK1.png")));
        } else {
            lblStatus.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/equivalencia/icones/dbErro1.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("SIS Equivalência SENAI Vitória - Tela de Login");
        setResizable(false);
        ...
        setSize(new java.awt.Dimension(434, 234));
